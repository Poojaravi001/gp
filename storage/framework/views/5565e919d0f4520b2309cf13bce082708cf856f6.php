      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="dropdown">
              <a href="<?php echo e(route('branch.index')); ?>" class="nav-link"><i data-feather="grid"></i><span>Branches</span></a>
            </li>
...
</html><?php /**PATH C:\xampp\htdocs\gp\resources\views\layouts\app.blade.php ENDPATH**/ ?>